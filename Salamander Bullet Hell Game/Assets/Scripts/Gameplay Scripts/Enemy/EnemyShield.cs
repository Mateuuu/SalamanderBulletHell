...
{
    private float shieldSlowdown;
    private bool shieldDeflectEnabled = false;
    private float bounceProbability;
    public void EnableShieldDeflect(bool shieldDeflectEnabled)
    {
        this.shieldDeflectEnabled = shieldDeflectEnabled;
    }
    public void SetBounceProbability(float bounceProbability)
    {
        this.bounceProbability = bounceProbability;
    }
    public void SetShieldSlowdown(float shieldSlowdown)
    {
        this.shieldSlowdown = shieldSlowdown;
    }
